...
public class Explorer extends AllyUnit {
    ...
    void run() {
        ...
        uc.println("communication.cornerTrackingStatus " + communication.cornerTrackingStatus);
        uc.println("communication.allBoundariesFound() " + communication.allBoundariesFound());
        ...
        movedLastTurn = tryAdjMoves(selfLocation.directionTo(dest));
    }
